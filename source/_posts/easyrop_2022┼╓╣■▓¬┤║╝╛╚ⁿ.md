...
![](../img/2706180-20220426101917635-1568812321.png)

![](../img/2706180-20220426101928743-1588465175.png)
...
![](../img/2706180-20220426101943521-1024948707.png)
...
![](../img/2706180-20220426101952307-600170163.png)
...
![](../img/2706180-20220426102004222-1183097211.png)
...
magic gadget似乎是一种统称？就是上面这种神奇的小玩意，师傅们都叫它magic gadget，似乎并不单指某个gadgets，因为前一段做[de1ctf_2019_unprintable](https://www.cnblogs.com/ZIKH26/articles/16167705.html)的时候，碰见了另一个magic_gadgets。
...
由于在alarm函数里syscall距离alarm函数的真实地址偏移仅仅为5，那岂不是说我**ebx存一个5，然后让rbp-0x3d为alarm的got地址，执行magic gadget就可以修改alarm的got表为syscall的真实地址**。如此我们再执行alarm函数的时候，就相当于执行的是syscall。
...
![](../img/2706180-20220426102017372-286472307.png)


现在看一下ida正常的两个指令，以及他们对应的十六进制机器码![](../img/2706180-20220426102025440-653483116.png)
![](../img/2706180-20220426102033744-1476514134.png)

![](../img/2706180-20220426102057610-1265266427.png)

![](../img/2706180-20220426102206921-1073508038.png)




发现将机器码再转成汇编，确实是原来的指令。不过我们现在去拿01 5d c3这段机器码（也就是上面两个指令之间的一部分）去得到我们想要的magic gadget（如下图）
![](../img/2706180-20220426102217546-987677091.png)
...
![](../img/2706180-20220426102225206-1415630040.png)



### 怎么理解这个错位得到的机器码？
![](../img/2706180-20220426102239185-1717796383.png)
...
![](../img/2706180-20220426102259813-2020062452.png)
...
![](../img/2706180-20220426103623192-486607434.png)
...
这个网站可以在线汇编指令转机器码   [here]((https://defuse.ca/online-x86-assembler.htm#disassembly))
...
![](../img/2706180-20220426103703621-1232925873.png)
...
![](../img/2706180-20220426103751910-1556922758.png)
...
![](../img/2706180-20220426103817080-960601662.png)
...
![](../img/2706180-20220426103846637-587580728.png)
...
![](../img/2706180-20220426103859734-1715666525.png)
...
![](../img/2706180-20220426103934059-170044952.png)
...
![](../img/2706180-20220426104003427-537650546.png)
...
![](../img/2706180-20220426102522302-1487885126.png)
