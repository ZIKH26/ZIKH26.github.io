...
![](../img/2706180-20220127203642840-2033345372.png)
...
![](../img/2706180-20220127203659117-356770839.png)





![](../img/2706180-20220127203712667-1709918883.png)
...
构造`payload位payload=p32(pop_eax_addr)+p32(11)`这样能达到效果的原因是执行pop eax的时候，栈顶就是11，此时就是把栈顶的11给弹进eax里面，即完成了传参。
...
![](../img/2706180-20220127203727516-678751435.png)



此时看保护还是正常的，但是用IDA就发现不对劲了
![](../img/2706180-20220127203739873-417953413.png)

![](../img/2706180-20220127203751365-839458355.png)
...
![](../img/2706180-20220127203803936-1340958560.png)

![](../img/2706180-20220127203818420-1093356739.png)
...
![](../img/2706180-20220127203856048-493266564.png)

![](../img/2706180-20220127203918982-250461252.png)
...
![](../img/2706180-20220127204005942-290500809.png)
...
![](../img/2706180-20220127204033314-1369511097.png)



这里直接就发现了连续pop三个寄存器的指令，比较nice。

![](../img/2706180-20220127204105424-1865663775.png)
...
![](../img/2706180-20220303194850099-1407586466.png)

![](../img/2706180-20220303194913108-59758844.png)



发现是静态链接，之前静态链接就是直接去用ropgadget搜了ropchain，然后我这道题直接搜了一下。
用下面这个命令搜（a是文件名）
![](../img/2706180-20220303195629484-228134511.png)
  ![](../img/2706180-20220303194931739-320603106.png)


 ![](../img/2706180-20220303194955331-2123755447.png)
发现没有canary，并且有溢出
那就没少好说的了，看一下溢出偏移

![](../img/2706180-20220303194941901-2106523077.png)
